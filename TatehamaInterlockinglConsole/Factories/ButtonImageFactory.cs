...
namespace TatehamaInterlockinglConsole.Factories
{
    public static class ButtonImageFactory
    {
        ...
        /// <returns></returns>
        public static UIElement CreateButtonImageControl(List<UIAllImagePaths> imagePaths, UIControlSetting setting, List<UIControlSetting> allSettings, bool drawing)
        {
