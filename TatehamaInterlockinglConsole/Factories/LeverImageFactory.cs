...
namespace TatehamaInterlockinglConsole.Factories
{
    public static class LeverImageFactory
    {
        ...
        /// <returns></returns>
        public static UIElement CreateLeverImageControl(List<UIAllImagePaths> imagePaths, UIControlSetting setting, List<UIControlSetting> allSettings, bool drawing)
        {
